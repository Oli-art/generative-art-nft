...
BASE_ANIMATION = "ipfs://QmXZZaMPo8pRMiUSm4NdbRPRiELadehYhQwYWGRNMZkf1j"
...
def main():
    ...
    gltf_ixd = [171, 294, 590, 699, 705, 1093, 1139, 1166, 1255, 1507, 1515, 1679, 1695, 1725, 1767, 1788, 1926, 1989, 2030, 2112, 2231, 2469, 2495]
    ...
    for idx, row in progressbar(df.iterrows()):    
        ...
        if idx in gltf_ixd:
            item_json['animation_url'] = item_json['animation_url'] + '/' + str(idx) + '.gltf'
        else:
            item_json['animation_url'] = item_json['animation_url'] + '/' + str(idx) + '.glb'
